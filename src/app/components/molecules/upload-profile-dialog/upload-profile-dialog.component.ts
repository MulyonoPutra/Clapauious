...
@Component({
  selector: 'app-upload-profile-dialog',
  templateUrl: './upload-profile-dialog.component.html',
  styleUrls: ['./upload-profile-dialog.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class UploadProfileDialogComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<UploadProfileDialogComponent>) {}
   ...
   */
  saveFile() {
    console.log('Saving to temporary storage', this.content)
